...
export default async function handler(req, res) {
  ...
  if (imageBase64) {
    ...
    content.push({ type: 'text', text: 'Please create LEGO building instructions to recreate what you see in this image!' });
  } else {
    const thing = subject || category;
    content.push({ type: 'text', text: `Please create LEGO building instructions for: ${thing}` });
  }
